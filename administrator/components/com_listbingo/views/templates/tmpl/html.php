...
JToolBarHelper::addNewX("templates.addHTML","Add");
JToolBarHelper::editList("templates.editHTML");
JToolBarHelper::cancel("templates.cancelTemplate");
JToolBarHelper::deleteList(JText::_('ASK_DELETE'),"templates.removeHTML");
gbimport("css.icons");
